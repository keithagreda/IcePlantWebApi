...
namespace POSIMSWebApi.Migrations.Application
{
    ...
    [Migration("20250323132845_addedPrinterLogs")]
    partial class addedPrinterLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.InventoryReconciliation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("InventoryReconciliations");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PrinterLogs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ProductCostDetails", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.ReportDetail", b =>
                {
                    ...
                    b.Property<decimal>("AverageGeneration")
                        .HasColumnType("numeric");
                    ...
                    b.Property<decimal>("TotalQtyGenerated")
                        .HasColumnType("numeric");

                    b.Property<decimal>("TotalQtySold")
                        .HasColumnType("numeric");
            ...
            modelBuilder.Entity("Domain.Entities.VoidRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.ProductCostDetails", b =>
                {
                    b.HasOne("Domain.Entities.ProductCost", "ProductCost")
            ...
            modelBuilder.Entity("Domain.Entities.ProductCost", b =>
                {
                    b.Navigation("ProductCostDetails");
                });
